...
import myImg from "../../Assets/vesikalik.jpg";
        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body" data-aos="fade-up">
              ...
              <i className="primary-header">.NET Framework</i> and Modern Javascript
              Library and Framework like
              <i className="primary-header"> Angular.</i>
              <br />
              <br />
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links" data-aos="fade-up">
              <li className="social-icons">
                <a
                  href="https://github.com/tarikonal"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://twitter.com/tarikonal"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                  aria-label="twitter"
              ...
              <li className="social-icons">
                <a
                  href="mailto:tarikonal@gmail.com"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                  aria-label="email"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/tarikonal/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                  aria-label="linkedin"
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/onal.tarik/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
